...
const HomePage = () => {
  ...
  //sepreted by coma and 2 array in commplasery in inndependence 
    ...
    <div>
      ...
      <header className="hero-section d-flex align-items-center justify-content-center text-white text-center vh-100 w-100 position-relative">
        ...
        <div className="container py-5 position-relative z-index-1">
          ...
          <h1 className="display-1 fw-bold  mb-4 animate__fadeInUp homeFount">
           Grow love with modern tools.” 🌾
          </h1>
          ...
          <p className="lead fw-light mt-3 mb-5 animate__fadeInUp animate__delay-1s">
            Explore advanced agri equipment, made for you.
          </p>
            ...
            <div key={product.id} className="col">
              ...
              >
                ...
                <div className="product-card-img-container">
                  ...
                  {/* and toFixed (2) use for to always show proper currency format in decimal */}
                ...
                <div className="card-body d-flex flex-column text-center p-4">
                  ...
                  {/* parsefolat is used to convert string into a number ensure it is always a  */}
